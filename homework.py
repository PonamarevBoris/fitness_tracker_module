...
class SportsWalking(Training):
    ...
    CONSTANT_CONVERTING_VALUES: float = 0.278
    SM_IN_M: int = 100
    ...
    def get_spent_calories(self) -> float:
        speed_in_m_s: float = (self.get_mean_speed()
                               * self.CONSTANT_CONVERTING_VALUES)
        height_in_m: float = self.height / self.SM_IN_M
        return ((self.CALORIES_WEIGHT_MULTIPLIER
                * self.weight
                + (speed_in_m_s ** 2 / height_in_m)
